...
export class SettingsScreen {
  ...
  mount() {
    ...
    this.root.innerHTML = `
      <div class="page-header">
        ...
        <div class="page-actions">
          <button id="settingsOpenInspectorBtn" class="btn ghost desktop-inspector-trigger" type="button">Open details</button>
        </div>
      </div>
    ...
    $("#settingsOpenInspectorBtn", this.root).addEventListener("click", () => {
  ...
  render() {
    ...
    this.renderSummary();
    const inspectorVisible = !document.getElementById("shellInspector")?.classList.contains("hidden");
    this.inspectorOpen = this.inspectorOpen && inspectorVisible;
