...
def _fallback_stages() -> Dict[str, dict]:
    return {
        ...
        "terminal_hub": {"id": "terminal_hub", "display_name": "Terminal Hub", "tagline": "Long floor with split side decks for scrappier resets.", "arena": {"w": ARENA_WIDTH, "h": ARENA_HEIGHT}, "blast_zone": {"left": -240, "right": 1840, "top": -260, "bottom": 1140}, "spawn_points": [[540, 650], [1060, 650], [400, 530], [1200, 530]], "platforms": [{"id": "main", "x": 240, "y": 780, "w": 1120, "h": 44}, {"id": "left", "x": 350, "y": 600, "w": 250, "h": 28}, {"id": "right", "x": 1000, "y": 600, "w": 250, "h": 28}, {"id": "mid", "x": 700, "y": 500, "w": 200, "h": 22}], "theme": {"sky_top": "#1d2434", "sky_bottom": "#394258", "fog": "#646d83", "ground": "#20252f", "ground_edge": "#ffc978", "platform": "#424c63", "platform_edge": "#ffe0aa", "accent": "#ffb54d", "shadow": "#11151d"}},
