...
def build_app() -> web.Application:
    ...
    app.router.add_get(
        "/{page:(home|login|lobby|play|arena|wallet|wallets|exchange|market|token_create|explorer|minigames|pong|reaction|typing|chess|messages|hub|community|dm|leaderboard|settings|coming_soon)\\.html}",
        page_handler,
    )
